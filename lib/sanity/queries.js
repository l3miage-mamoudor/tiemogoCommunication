...
export const projectsQuery = `*[_type == "project"] | order(order desc){ client, "slug": slug.current, sector, image, category }`;

export const projectBySlugQuery = `*[_type == "project" && slug.current == $slug][0]{ client, "slug": slug.current, sector, image, category, description }`;
